...
@section('lala')
    ...
    <div class="row justify-content-center mt-4">
        <h1 class="p-1 h3 fw-normal text-center text-light bg-dark">Buat Pesanan</h1>
    </div>
                        ...
                        <tr>
                            <td >
                                ...
                                <div class="form-floating">
                                    ...
                                    <input type="number" id="qtyc" class="form-control" name="qtyc">
                                </div>
                                <div class="form-floating">
                                    <label for="perqtyc">Harga /Qty coffe</label>
                                    <input type="number" id="perqtyc" value="20000" class="form-control" name="perqtyc">
                                </div>
                            </td>
                        </tr>
                    </table>
                    ...
                    <tr>
                        <td >
                            ...
                            <div class="form-floating">
                                ...
                                <input type="number" id="qtya" class="form-control" name="qtya">
                            </div>
                            <div class="form-floating">
                                <label for="perqtya">Harga /Qty Bland</label>
                                <input type="number" id="perqtya" value="15000" class="form-control" name="perqtya">
                            </div>
                        </td>
                    </tr>
                    </table>
                    ...
                    <tr>
                        <td >
                            ...
                            <div class="form-floating">
                                ...
                                <input type="number" id="qtyb" class="form-control" name="qtyb">
                            </div>
                            <div class="form-floating">
                                <label for="perqtyb">Harga /Qty Bvrages</label>
                                <input type="number" id="perqtyb" value="25000" class="form-control" name="perqtyb">
                            </div>
                        </td>
                    </tr>
                    </table>
                </div>
                <button class="w-75 btn btn-info text-dark" type="submit">Pesan</button>
            </form>
        </center>
